...
Известные баги:
1) посворачивали приложение по разному, потом закрываем приложение, а иконка в трее не выключается.
...
if not _WorkWithTray then exit;
