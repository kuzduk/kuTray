...
s := ExtractFilePath(Application.ExeName) + 'settings.ini';
...
begin
  ...
  try
      //WorkWithTray
      _WorkWithTray := ini.ReadBool( 'Settings', 'WorkWithTray', True );
      Form1.chWorkWithTray.Checked := _WorkWithTray;
      ...
      if Form1.chRunMinimizedToTray.Checked and _WorkWithTray then MinimizeToTray;
